...
exports.SkillBackCard = void 0;
const reactstrap_1 = require("reactstrap");
const react_1 = require("react");
const SkillBackCard = ({ skillsBack }) => {
    ...
    return (<>
            ...
            <reactstrap_1.Modal isOpen={open} toggle={toggle} className="myModal" modalClassName="myModalDialog" contentClassName="myModalContent" wrapClassName="myModalBackdrop">
                ...
                <reactstrap_1.ModalHeader className="myModalHeader">Back-end Skills</reactstrap_1.ModalHeader>

                <reactstrap_1.ModalBody className="myModalBody">

                    <ul className="list-unstyled mb-0">
                        {skillsBack.map((skill) => (<li key={skill.id} className="d-flex align-items-center gap-2 mb-2">
...
exports.SkillBackCard = SkillBackCard;
